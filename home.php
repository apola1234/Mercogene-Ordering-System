      ...
      <div class="row">
        <div class="col-sm-12">
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Mercogene Pharmacy</span> and General Merchandise</h1>
                  <h2></h2>
                  <p></p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/pic1.png" class="girl img-responsive" alt="" />
                </div>
              </div>
              <div class="item">
                <div class="col-sm-6">
		  ...
		  <br> Monday - Sunday </br>
                ...
                <div class="col-sm-6">
                  <img src="images/home/pic2.jpg" class="girl img-responsive" alt="" />
                </div>
              </div>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Mercogene Pharmacy</span> and General Merchandise</h1>
                  <h2>Social Media</h2>
                  <p>Facebook:</bold> Mercogene Pharmacy and General Merchandise
		  <br>Email:   mercogenepharmacy@yahoo.com </br></p>

                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/pic3.jpg" class="girl img-responsive" alt="" />
